				...
				<div class="cover-container row">
					...
					<?php endif; ?>
						...
						<?php if(!empty($latte_intro_scroll)) : ?>
							<a href="<?php echo esc_url($latte_intro_scroll); ?>" class="arrow"><i id="introArrow" class="fa fa-chevron-down"></i></a>
						<?php elseif(empty($latte_intro_scroll) && is_customize_preview()) : ?>
							<a href="<?php echo esc_url($latte_intro_scroll); ?>" class="arrow customizer-hidden"><i id="introArrow" class="fa fa-chevron-down"></i></a>
						<?php endif; ?>
					</div>
				</div>
			</div>
